  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="h2_header">Explore</ThemedText>
      </ThemedView>
      ...
      <Collapsible title="Custom fonts">
        <ThemedText>
          Open <ThemedText type="default">app/_layout.tsx</ThemedText> to see how to load{' '}
      ...
      <Collapsible title="Animations">
        <ThemedText>
          ...
          the powerful <ThemedText type="default">react-native-reanimated</ThemedText>{' '}
